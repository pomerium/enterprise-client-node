...
// @generated from protobuf file "xds/type/matcher/v3/string.proto" (package "xds.type.matcher.v3", syntax proto3)
// tslint:disable
 ...
 * [#next-free-field: 8]
 *
 * @generated from protobuf message xds.type.matcher.v3.StringMatcher
 */
export interface StringMatcher {
    ...
    matchPattern: {
         ...
         *
         * @generated from protobuf field: xds.type.matcher.v3.RegexMatcher safe_regex = 5;
         */
 ...
 *
 * @generated from protobuf message xds.type.matcher.v3.ListStringMatcher
 */
export interface ListStringMatcher {
    /**
     * @generated from protobuf field: repeated xds.type.matcher.v3.StringMatcher patterns = 1;
     */
...
class StringMatcher$Type extends MessageType<StringMatcher> {
    constructor() {
        super("xds.type.matcher.v3.StringMatcher", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string suffix */ 3:
                    ...
                    break;
                case /* xds.type.matcher.v3.RegexMatcher safe_regex */ 5:
                    message.matchPattern = {
                        oneofKind: "safeRegex",
    ...
    internalBinaryWrite(message: StringMatcher, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* xds.type.matcher.v3.RegexMatcher safe_regex = 5; */
...
/**
 * @generated MessageType for protobuf message xds.type.matcher.v3.StringMatcher
 */
export const StringMatcher = new StringMatcher$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListStringMatcher$Type extends MessageType<ListStringMatcher> {
    constructor() {
        super("xds.type.matcher.v3.ListStringMatcher", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListStringMatcher): ListStringMatcher {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated xds.type.matcher.v3.StringMatcher patterns */ 1:
    ...
    internalBinaryWrite(message: ListStringMatcher, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated xds.type.matcher.v3.StringMatcher patterns = 1; */
...
/**
 * @generated MessageType for protobuf message xds.type.matcher.v3.ListStringMatcher
 */
