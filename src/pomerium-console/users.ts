        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for pomerium.dashboard.UserInfo.namespace_roles");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class QueryGroupsResponse$Type extends MessageType<QueryGroupsResponse> {
    constructor() {
        super("pomerium.dashboard.QueryGroupsResponse", [
            { no: 1, name: "groups", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => GroupInfo },
...
class QueryUsersResponse$Type extends MessageType<QueryUsersResponse> {
    constructor() {
        super("pomerium.dashboard.QueryUsersResponse", [
            { no: 1, name: "users", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => UserInfo },
            { no: 2, name: "total_count", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class ListPomeriumServiceAccountsResponse$Type extends MessageType<ListPomeriumServiceAccountsResponse> {
    constructor() {
        super("pomerium.dashboard.ListPomeriumServiceAccountsResponse", [
            { no: 1, name: "service_accounts", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PomeriumServiceAccount }
        ]);
    }
...
class PomeriumSession$Type extends MessageType<PomeriumSession> {
    constructor() {
        super("pomerium.dashboard.PomeriumSession", [
            ...
            { no: 3, name: "groups", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PomeriumSession_Group },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for pomerium.dashboard.PomeriumSession.claims");
            }
        }
...
class GetPomeriumSessionResponse$Type extends MessageType<GetPomeriumSessionResponse> {
    constructor() {
        super("pomerium.dashboard.GetPomeriumSessionResponse", [
            ...
            { no: 2, name: "associated_sessions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PomeriumSession }
        ]);
    }
...
class ListPomeriumSessionsResponse$Type extends MessageType<ListPomeriumSessionsResponse> {
    constructor() {
        super("pomerium.dashboard.ListPomeriumSessionsResponse", [
            { no: 1, name: "sessions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => PomeriumSession },
            { no: 2, name: "total_count", kind: "scalar", T: 3 /*ScalarType.INT64*/, L: 0 /*LongType.BIGINT*/ }
        ]);
    }
...
class ListPomeriumSessionsForImpersonationResponse$Type extends MessageType<ListPomeriumSessionsForImpersonationResponse> {
    constructor() {
        super("pomerium.dashboard.ListPomeriumSessionsForImpersonationResponse", [
            { no: 1, name: "sessions", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ListPomeriumSessionsForImpersonationResponse_Session }
        ]);
    }
