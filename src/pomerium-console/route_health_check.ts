...
class HealthCheck_HttpHealthCheck$Type extends MessageType<HealthCheck_HttpHealthCheck> {
    constructor() {
        super("pomerium.dashboard.HealthCheck.HttpHealthCheck", [
            ...
            { no: 9, name: "expected_statuses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Int64Range },
            { no: 12, name: "retriable_statuses", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Int64Range },
...
class HealthCheck_TcpHealthCheck$Type extends MessageType<HealthCheck_TcpHealthCheck> {
    constructor() {
        super("pomerium.dashboard.HealthCheck.TcpHealthCheck", [
            ...
            { no: 2, name: "receive", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => HealthCheck_Payload }
        ]);
    }
