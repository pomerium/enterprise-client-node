        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for pomerium.dashboard.ExternalDataSource.headers");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
class ListExternalDataSourcesResponse$Type extends MessageType<ListExternalDataSourcesResponse> {
    constructor() {
        super("pomerium.dashboard.ListExternalDataSourcesResponse", [
            { no: 1, name: "external_data_sources", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => ExternalDataSource }
        ]);
    }
