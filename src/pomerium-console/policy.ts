        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    ...
                    break;
                default: throw new globalThis.Error("unknown map entry field for pomerium.dashboard.Policy.allowed_idp_claims");
            }
        }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for pomerium.dashboard.Policy.routes");
            }
        }
        map[key ?? ""] = val ?? "";
    }
